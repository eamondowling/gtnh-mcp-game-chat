 ...
 * Also provides a static method for the /hermes guide command.
 */
public class GuideBook {

    private static final String[] PAGES = {
        // Page 1 — Intro
        "§lHermes Agent Guide§r\n\n" +
    ...
    public static ItemStack create() {
        ...
        tag.setString("title", "Hermes Agent Guide");
        tag.setString("author", "Hermes");
    ...
    public static void giveToPlayer(EntityPlayer player) {
        ...
        player.addChatMessage(new ChatComponentText(
            "§a[ Hermes]§r Guide book added to your inventory. Right-click to read!"
        ));
    }
